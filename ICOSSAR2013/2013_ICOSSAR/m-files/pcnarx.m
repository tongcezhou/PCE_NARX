function [thetaij,res,criteria] = pcnarx(Y,X,Q,orders,indx,customreg,th0,options)
...
if isempty(X)
    ...
    n = na;
    % PE estimation method
    [thetaij,res,criteria] = pcnarxPE(Y,[],indx,customreg);
% PC-ARX case
else
    % AR order
    na = orders(1);
    ...
    if strcmp(options.focus,'prediction')
        ...
        if isempty(th0) && ( ~(isfield(options,'PEinit')) || strcmp(options.PEinit,'n') )
            ...
            th0 = pcnarxPE(Y,X,indx,customreg);
        end
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [THETA,res,criteria] = pcnarxPE(Y,X,indx,customreg)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [TH,res,criteria] = pcnarxSIM(TH0,Y,X,indx,customreg,options)
