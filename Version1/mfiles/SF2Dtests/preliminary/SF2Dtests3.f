...
*DO,I,1,NoS				! Time index DO LOOP
	...
	! Application of the X-axis & gravity acceleration 
		...
		*DO,ElemI,1,35				! Time index DO LOOP
			STRx = STRCAT('SF2Dtest3_Sx_',CHRVAL(ElemI))
			STRy = STRCAT('SF2Dtest3_Sy_',CHRVAL(ElemI))
			STRz = STRCAT('SF2Dtest3_Sz_',CHRVAL(ElemI))
			STRxy = STRCAT('SF2Dtest3_Sxy_',CHRVAL(ElemI))
			STRyz = STRCAT('SF2Dtest3_Syz_',CHRVAL(ElemI))
			STRxz = STRCAT('SF2Dtest3_Sxz_',CHRVAL(ElemI))
			
			EPSx = STRCAT('SF2Dtest3_Ex_',CHRVAL(ElemI))
			EPSy = STRCAT('SF2Dtest3_Ey_',CHRVAL(ElemI))
			EPSz = STRCAT('SF2Dtest3_Ez_',CHRVAL(ElemI))
			EPSxy = STRCAT('SF2Dtest3_Exy_',CHRVAL(ElemI))
			EPSyz = STRCAT('SF2Dtest3_Eyz_',CHRVAL(ElemI))
			EPSxz = STRCAT('SF2Dtest3_Exz_',CHRVAL(ElemI))
