...
(9(E16.7,2X))
	...
	*DO,I,1,NoS				! Time index DO LOOP
		...
		*GET,Ux5,NODE,5,U,X 		! X displacement at node 5		
		*GET,Ux7,NODE,7,U,X 		! X displacement at node 7		
		...
		*GET,Vx5,NODE,5,V,X 		! X velocity at node 5		
		*GET,Vx7,NODE,7,V,X 		! X velocity at node 7		
		...
		*GET,Ax5,NODE,5,A,X			! X acceleration at node 5
		*GET,Ax7,NODE,7,A,X			! X acceleration at node 7
		...
		*GET,Sx1,SECR,1,S,X,MAX 	! X stress at element 1		
		*GET,Sx2,SECR,2,S,X,MAX 	! X stress at element 2
		*GET,Sx3,SECR,3,S,X,MAX 	! X stress at element 3
		*GET,Sx4,SECR,4,S,X,MAX 	! X stress at element 4
		*GET,Sx5,SECR,5,S,X,MAX 	! X stress at element 5		
		*GET,Sx6,SECR,6,S,X,MAX 	! X stress at element 6		
		*GET,Sx7,SECR,7,S,X,MAX 	! X stress at element 7
		*GET,Sx8,SECR,8,S,X,MAX 	! X stress at element 8
		*GET,Sx9,SECR,9,S,X,MAX 	! X stress at element 9
		*GET,Sx10,SECR,10,S,X,MAX 	! X stress at element 10		
		*GET,Sx11,SECR,11,S,X,MAX 	! X stress at element 11		
		*GET,Sx12,SECR,12,S,X,MAX 	! X stress at element 12
		*GET,Sx13,SECR,13,S,X,MAX 	! X stress at element 13
		*GET,Sx14,SECR,14,S,X,MAX 	! X stress at element 14
		*GET,Sx15,SECR,15,S,X,MAX 	! X stress at element 15		
		...
		*VWRITE,Tindx,Gacc,ReacFx1+ReacFx2,Sx1,Sx2,Sx3,Sx4,Sx5,Sx6,Sx7,Sx8,Sx9,Sx10,Sx11,Sx12,Sx13,Sx14,Sx15
(18(E16.7,2X))
		*CFCLOS					! Close 'SFresI' txt file
		*CFOPEN,STRd,txt,,APPEND		! Open txt file
		*VWRITE,Tindx,Gacc,ReacFx1+ReacFx2,Ux2,Ux5,Ux7,Ux9,Ux11,Ux4,Ux6,Ux8,Ux10,Ux12
(13(E16.7,2X))
		*CFCLOS					! Close 'SFresI' txt file	
		*CFOPEN,STRv,txt,,APPEND		! Open txt file
		*VWRITE,Tindx,Gacc,ReacFx1+ReacFx2,Vx2,Vx5,Vx7,Vx9,Vx11,Vx4,Vx6,Vx8,Vx10,Vx12
(13(E16.7,2X))
		*CFCLOS					! Close 'SFresI' txt file	
		*CFOPEN,STRa,txt,,APPEND		! Open txt file
		*VWRITE,Tindx,Gacc,ReacFx1+ReacFx2,Ax2,Ax5,Ax7,Ax9,Ax11,Ax4,Ax6,Ax8,Ax10,Ax12
(13(E16.7,2X))
		*CFCLOS					! Close 'SFresI' txt file
