...
STRd = 'SF2Dtest3_10_dspl'
STRv = 'SF2Dtest3_10_vel'
STRa = 'SF2Dtest3_10_acc'
...
*DO,I,1,NoS				! Time index DO LOOP
	...
	*DO,ElemI,1,1				! Time index DO LOOP
		STRx = STRCAT('SF2Dtest3_10_Sx_',CHRVAL(ElemI))
		STRy = STRCAT('SF2Dtest3_10_Sy_',CHRVAL(ElemI))
		STRz = STRCAT('SF2Dtest3_10_Sz_',CHRVAL(ElemI))
		STRxy = STRCAT('SF2Dtest3_10_Sxy_',CHRVAL(ElemI))
		STRyz = STRCAT('SF2Dtest3_10_Syz_',CHRVAL(ElemI))
		STRxz = STRCAT('SF2Dtest3_10_Sxz_',CHRVAL(ElemI))
		
		EPSx = STRCAT('SF2Dtest3_10_Ex_',CHRVAL(ElemI))
		EPSy = STRCAT('SF2Dtest3_10_Ey_',CHRVAL(ElemI))
		EPSz = STRCAT('SF2Dtest3_10_Ez_',CHRVAL(ElemI))
		EPSxy = STRCAT('SF2Dtest3_10_Exy_',CHRVAL(ElemI))
		EPSyz = STRCAT('SF2Dtest3_10_Eyz_',CHRVAL(ElemI))
		EPSxz = STRCAT('SF2Dtest3_10_Exz_',CHRVAL(ElemI))
