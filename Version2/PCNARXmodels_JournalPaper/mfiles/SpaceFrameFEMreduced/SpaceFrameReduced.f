...
(10(E16.7,2X))
	...
	*DO,I,1,NoS				! Time index DO LOOP
		...
		*GET,Vx27,NODE,27,V,X		! X velocity at node 27
		*GET,Vx36,NODE,36,V,X		! X velocity at node 36
		*GET,Vx45,NODE,45,V,X		! X velocity at node 45
		*GET,Vx54,NODE,54,V,X		! X velocity at node 54
		...
		*VWRITE,Tindx,Gacc,ReacFx1+ReacFx2+ReacFx3+ReacFx4+ReacFx5+ReacFx6+ReacFx7+ReacFx8+ReacFx9,Ux18,Ux27,Ux36,Ux45,Ux54,Vx18,Vx27,Vx36,Vx45,Vx54,Ax18+Gacc,Ax27+Gacc,Ax36+Gacc,Ax45+Gacc,Ax54+Gacc
(18(E16.7,2X))
