...
! Input Force
Finput = EXCIT(1)
F,2,FX,Finput,,18,2		! 1st floor
F,19,FX,Finput*2,,27,1	! 2nd floor
F,28,FX,Finput*3,,36,1	! 3rd floor
F,37,FX,Finput*4,,45,1	! 4th floor
F,46,FX,Finput*5,,54,1	! 5th floor
...
*DO,I,1,NoS				! Time index DO LOOP
	...
	*GET,Sx10,SECR,10,S,X,MAX 	! X displacement at element 10
	*GET,Sx19,SECR,19,S,X,MAX 	! X displacement at element 19
	*GET,Sx28,SECR,28,S,X,MAX 	! X displacement at element 28
	*GET,Sx37,SECR,37,S,X,MAX 	! X displacement at element 37
	...
	*VWRITE,Tindx,Finput,ReacFx1+ReacFx2+ReacFx3+ReacFx4+ReacFx5+ReacFx6+ReacFx7+ReacFx8+ReacFx9,Ux18,Ux27,Ux36,Ux45,Ux54,Sx1,Sx10,Sx19,Sx28,Sx37
(13(E16.7,2X))
