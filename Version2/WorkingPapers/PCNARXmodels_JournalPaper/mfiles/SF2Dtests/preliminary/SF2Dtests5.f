...
! Meshing 
LESIZE,ALL,,,5,1,1  					! Specifies the divisions (3) and spacing ratio on unmeshed lines (no division, no spacing ratio)
...
*DO,I,1,NoS				! Time index DO LOOP
	...
	*DO,ElemI,1,1				! Time index DO LOOP
		STRx = STRCAT('SF2Dtest5_Sx_',CHRVAL(ElemI))
		STRy = STRCAT('SF2Dtest5_Sy_',CHRVAL(ElemI))
		STRz = STRCAT('SF2Dtest5_Sz_',CHRVAL(ElemI))
		STRxy = STRCAT('SF2Dtest5_Sxy_',CHRVAL(ElemI))
		STRyz = STRCAT('SF2Dtest5_Syz_',CHRVAL(ElemI))
		STRxz = STRCAT('SF2Dtest5_Sxz_',CHRVAL(ElemI))
		
		EPSx = STRCAT('SF2Dtest5_Ex_',CHRVAL(ElemI))
		EPSy = STRCAT('SF2Dtest5_Ey_',CHRVAL(ElemI))
		EPSz = STRCAT('SF2Dtest5_Ez_',CHRVAL(ElemI))
		EPSxy = STRCAT('SF2Dtest5_Exy_',CHRVAL(ElemI))
		EPSyz = STRCAT('SF2Dtest5_Eyz_',CHRVAL(ElemI))
		EPSxz = STRCAT('SF2Dtest5_Exz_',CHRVAL(ElemI))
...
(18(E16.7,2X))
	...
	*GET,Ux2r,NODE,13,U,X 		! X displacement at node 5		
	*GET,Ux3r,NODE,23,U,X 		! X displacement at node 7		
	*GET,Ux4r,NODE,33,U,X 		! X displacement at node 9		
	*GET,Ux5r,NODE,43,U,X 		! X displacement at node 11		
	*GET,Ux1l,NODE,8,U,X 		! X displacement at node 4
	*GET,Ux2l,NODE,18,U,X 		! X displacement at node 6		
	*GET,Ux3l,NODE,28,U,X 		! X displacement at node 8		
	*GET,Ux4l,NODE,38,U,X 		! X displacement at node 10		
	*GET,Ux5l,NODE,48,U,X 		! X displacement at node 12		
	
	*GET,Vx1r,NODE,2,V,X 		! X velocity at node 2
	*GET,Vx2r,NODE,13,V,X 		! X velocity at node 5		
	*GET,Vx3r,NODE,23,V,X 		! X velocity at node 7		
	*GET,Vx4r,NODE,33,V,X 		! X velocity at node 9		
	*GET,Vx5r,NODE,43,V,X 		! X velocity at node 11		
	*GET,Vx1l,NODE,8,V,X 		! X velocity at node 4
	*GET,Vx2l,NODE,18,V,X 		! X velocity at node 6		
	*GET,Vx3l,NODE,28,V,X 		! X velocity at node 8		
	*GET,Vx4l,NODE,38,V,X 		! X velocity at node 10		
	*GET,Vx5l,NODE,48,V,X 		! X velocity at node 12		
	
	*GET,Ax1r,NODE,2,A,X		! X acceleration at node 2
	*GET,Ax2r,NODE,13,A,X		! X acceleration at node 5
	*GET,Ax3r,NODE,23,A,X		! X acceleration at node 7
	*GET,Ax4r,NODE,33,A,X		! X acceleration at node 9
	*GET,Ax5r,NODE,43,A,X		! X acceleration at node 11
	*GET,Ax1l,NODE,8,A,X		! X acceleration at node 4
	*GET,Ax2l,NODE,18,A,X		! X acceleration at node 6
	*GET,Ax3l,NODE,28,A,X		! X acceleration at node 8
	*GET,Ax4l,NODE,38,A,X		! X acceleration at node 10
	*GET,Ax5l,NODE,48,A,X		! X acceleration at node 12
	
	*GET,ReacFx1,NODE,1,RF,FX 	! X Reaction Force at node 1
	*GET,ReacFx2,NODE,7,RF,FX 	! X Reaction Force at node 2
