...
! Meshing 
LESIZE,ALL,,,3,1,1  					! Specifies the divisions (3) and spacing ratio on unmeshed lines (no division, no spacing ratio)
...
STRd = 'SF2Dtest3_1000_dspl'
STRv = 'SF2Dtest3_1000_vel'
STRa = 'SF2Dtest3_1000_acc'
...
*DO,I,1,NoS				! Time index DO LOOP
	...
	*DO,ElemI,1,1				! Time index DO LOOP
		STRx = STRCAT('SF2Dtest3_1000_Sx_',CHRVAL(ElemI))
		STRy = STRCAT('SF2Dtest3_1000_Sy_',CHRVAL(ElemI))
		STRz = STRCAT('SF2Dtest3_1000_Sz_',CHRVAL(ElemI))
		STRxy = STRCAT('SF2Dtest3_1000_Sxy_',CHRVAL(ElemI))
		STRyz = STRCAT('SF2Dtest3_1000_Syz_',CHRVAL(ElemI))
		STRxz = STRCAT('SF2Dtest3_1000_Sxz_',CHRVAL(ElemI))
		
		EPSx = STRCAT('SF2Dtest3_1000_Ex_',CHRVAL(ElemI))
		EPSy = STRCAT('SF2Dtest3_1000_Ey_',CHRVAL(ElemI))
		EPSz = STRCAT('SF2Dtest3_1000_Ez_',CHRVAL(ElemI))
		EPSxy = STRCAT('SF2Dtest3_1000_Exy_',CHRVAL(ElemI))
		EPSyz = STRCAT('SF2Dtest3_1000_Eyz_',CHRVAL(ElemI))
		EPSxz = STRCAT('SF2Dtest3_1000_Exz_',CHRVAL(ElemI))
