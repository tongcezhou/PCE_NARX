...
*CREATE,ansuitmp                                                                                                                    
*VREAD,EXCIT,'testINincr','txt',,IJK,NoS,1
(E16.7)                                                                                                                                                                
*END                                                                                                                                                                   
/INPUT,ansuitmp
FINISH
...
STRd = 'SF2Dtest1_dspl_incr'
STRv = 'SF2Dtest1_vel_incr'
STRa = 'SF2Dtest1_acc_incr'
...
*DO,I,1,NoS				! Time index DO LOOP
	...
	*DO,ElemI,1,1				! Time index DO LOOP
		STRx = STRCAT('SF2Dtest1_incr_Sx_',CHRVAL(ElemI))
		STRy = STRCAT('SF2Dtest1_incr_Sy_',CHRVAL(ElemI))
		STRz = STRCAT('SF2Dtest1_incr_Sz_',CHRVAL(ElemI))
		STRxy = STRCAT('SF2Dtest1_incr_Sxy_',CHRVAL(ElemI))
		STRyz = STRCAT('SF2Dtest1_incr_Syz_',CHRVAL(ElemI))
		STRxz = STRCAT('SF2Dtest1_incr_Sxz_',CHRVAL(ElemI))
		
		EPSx = STRCAT('SF2Dtest1_incr_Ex_',CHRVAL(ElemI))
		EPSy = STRCAT('SF2Dtest1_incr_Ey_',CHRVAL(ElemI))
		EPSz = STRCAT('SF2Dtest1_incr_Ez_',CHRVAL(ElemI))
		EPSxy = STRCAT('SF2Dtest1_incr_Exy_',CHRVAL(ElemI))
		EPSyz = STRCAT('SF2Dtest1_incr_Eyz_',CHRVAL(ElemI))
		EPSxz = STRCAT('SF2Dtest1_incr_Exz_',CHRVAL(ElemI))
