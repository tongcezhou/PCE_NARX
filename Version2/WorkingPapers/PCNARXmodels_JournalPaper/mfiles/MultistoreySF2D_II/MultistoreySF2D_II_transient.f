...
*IF,UNCERT,EQ,1,THEN
	...
	*VREAD,BeamProps(1),'BeamProps20','txt',,IJK,NoExp,1
(E16.7)                                                                                                                                                                
*ENDIF
...
*CREATE,ansuitmp                                                                                                                    
*VREAD,EXCIT,'AccRandom20','txt',,IJK,NoExp*NoS,1
(E16.7)                                                                                                                                                                
*END                                                                                                                                                                   
/INPUT,ansuitmp
...
*DO,J,1,NoExp			! Experiments DO LOOP
	...
	STRin = STRCAT('MultiII20_',CHRVAL(J))
	STRd = STRCAT('MultiII20_dspl_',CHRVAL(J))
	STRv = STRCAT('MultiII20_vel_',CHRVAL(J))
	STRa = STRCAT('MultiII20_acc_',CHRVAL(J))
	...
	*IF,UNCERT,EQ,1,THEN
		...
		! =====================================================
		*CFOPEN,'MProps20',txt,,APPEND			! Open txt file
...
(9(E16.7,2X))
	...
	*DO,I,1,NoS				! Time index DO LOOP
		...
		*DO,ElemI,1,25				! Time index DO LOOP
			STRx = STRCAT('MultiII20_Sx_',CHRVAL(ElemI))
			STRx = STRCAT(STRx,'_')
